...
import static com.crazylabs.hair.dye.challeng.Global.FUNC_ID;
import static com.crazylabs.hair.dye.challeng.MainActivity.C_STR1;
import static com.crazylabs.hair.dye.challeng.MainActivity.C_STR2;
import static com.crazylabs.hair.dye.challeng.MainActivity.C_STR3;
import static com.crazylabs.hair.dye.challeng.MainActivity.DLNK1;
import static com.crazylabs.hair.dye.challeng.MainActivity.DLNK2;
import static com.crazylabs.hair.dye.challeng.MainActivity.DLNK3;
...
public class RealActivity extends AppCompatActivity {
    ...
    public String getUrl(){
        ...
        String  cstr1, cstr2, cstr3, main_id, dlnk1, dlnk2, dlnk3, paket;
        ...
        cstr2 = Hawk.get(C_STR2);
        cstr3 = Hawk.get(C_STR3);

        dlnk1 = Hawk.get(DLNK1);
        dlnk2 = Hawk.get(DLNK2);
        dlnk3 = Hawk.get(DLNK3);
        ...
        String first1 = "https://";
        String second2 = "tracker.infinitum.works/Xsky7X";
       ...
       String fff;
        ...
        if (cstr1!=null){
            ...
            fff = whole + "?" + one + cstr1 + "&" + two + cstr2 + "&" + three + cstr3 + "&" + four + afId + "&" + five + main_id + "&" + six + paket;

        }
        else{

            fff = whole + "?" + one + dlnk1 + "&" + two + dlnk2 + "&" + three + dlnk3 + "&" + four + afId + "&" + five + main_id + "&" + six + paket;
        }
